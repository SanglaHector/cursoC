...
//**************************************************************************************************************
void altaE(eEmpleado vec[], int tam,eSector sectores[], int tamSec){
    int legajo;
    int repetido;
    int sector = 0;
    int validar = -1;
    ...
    if (indice == -1){
        ...
        if (repetido == -1){
            ...
            while (opcion != -1){
                ...
                sector = menuSector(sectores,tamSec,vec,tam);
                if(sector == -1){

                    printf("ha seleccionado una opcion incorrecta, intente de nuevo");
            }
            }
...
//*****************************************************************************************************************************
int menuSector(eSector sectores[], int tamSec , eEmpleado vec[], int tam){

   int opcion = 0;
    printf("\nIngrese una opcion: ");
    for(int i = 0 ; i < tam ; i++){
        printf("\n1. %s", sectores[i].descripcion);
    }
    scanf("%d", &opcion);
    if(opcion <= 0 || opcion > tamSec){
